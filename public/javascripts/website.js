...
var isOpened = false, urlState = {q:null,from:null,wp:[],pids:[],dpid:null,vp:[],lp:null,nf:null};
...
function restoreStateFromUrl() {
	...
	if (query && query.length) {
		...
		if (queryTerms.nf !== undefined) { urlState.lf = (queryTerms.nf === "1" || queryTerms.nf === "true"); }
